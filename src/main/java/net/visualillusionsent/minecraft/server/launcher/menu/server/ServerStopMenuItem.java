...
public final class ServerStopMenuItem extends JMenuItem implements ActionListener {
    private static final long serialVersionUID = 11184005272013L;

    public ServerStopMenuItem(ServerMenu sm) {
        super("Stop");
        setEnabled(false);
        this.addActionListener(this);

        this.setMnemonic(KeyEvent.VK_X);
        this.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, InputEvent.CTRL_DOWN_MASK));
    }
